					...
					(t.exports = function (t, e, n, u) {
						...
						b
							? ((p = n(function (t, n, r, o) {
									...
									if (_(n)) {
										if (
											!(n instanceof z || "ArrayBuffer" == (u = w(n)) || "SharedArrayBuffer" == u)
										)
		...
		function (t, e, n) {
			for (
				...
				var v,
					...
					b = a[m],
					w = b && b.prototype
				if (w && (w[f] || s(w, f, d), w[l] || s(w, l, m), (u[m] = d), g)) for (v in r) w[v] || i(w, v, r[v], !0)
			}
		},
		function (t, e, n) {
			;(function (e) {
							...
							e.default = {
								...
								removeClose: function () {
									...
									M("uniwebview://remove_close"),
										("ios" !== t && "mac" !== t && "android" !== t) || (0, f.default)("removeClose")
								},
								fetchAudio: function () {
									var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
										e = b(t),
							...
							Object.defineProperty(e, "__esModule", { value: !0 }),
								(e.getTips = function (t) {
									switch (t) {
										...
										case "chs":
										case "zh-cn":
											return ["确定", "前往", "返回", "离开", "半夏公益服", "目前已开设3.7指令服"]
										case "cht":
										case "zh-tw":
